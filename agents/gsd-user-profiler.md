...
<reference>
@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Proyectos Github/Watchbug_TFG/gsd-core/references/user-profiling.md` to load:
