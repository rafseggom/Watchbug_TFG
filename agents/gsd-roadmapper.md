...
Reference full template: `E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/state.md`.
