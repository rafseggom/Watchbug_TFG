...
<required_reading>
@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/verification-overrides.md
...
@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/verify-mvp-mode.md`.
