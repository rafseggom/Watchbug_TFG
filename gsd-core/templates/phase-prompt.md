...
<!-- For checkpoint task examples and patterns, see @E:/Proyectos Github/Watchbug_TFG/gsd-core/references/checkpoints.md -->
...
See `E:/Proyectos Github/Watchbug_TFG/gsd-core/references/tdd.md` for TDD plan structure.
...
See `E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/user-setup.md` for full schema and examples
...
See `E:/Proyectos Github/Watchbug_TFG/gsd-core/workflows/verify-phase.md` for verification logic.
