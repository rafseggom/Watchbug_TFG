...
- Usage: Reference from command with `@E:/Proyectos Github/Watchbug_TFG/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to E:/Proyectos Github/Watchbug_TFG/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/Proyectos Github/Watchbug_TFG/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
