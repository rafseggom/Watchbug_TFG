...
function evaluateWorktreeBaseDegrade(deps) {
    ...
    // Cline's worktree.baseRef accepts only "fresh" (= origin/HEAD, the default) or "head".
    ...
    // semantics and must be evaluated against origin/HEAD. (Reference: Cline worktrees docs, #683.)
