...
ones). Reference: @E:/Proyectos Github/Watchbug_TFG/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / E:/Proyectos Github/Watchbug_TFG.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "E:/Proyectos Github/Watchbug_TFG/gsd-core/bin/lib/edge-probe.cjs" \
  "E:/Proyectos Github/Watchbug_TFG/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @E:/Proyectos Github/Watchbug_TFG/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/spec.md.
