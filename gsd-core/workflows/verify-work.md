...
<template>
@E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/Proyectos Github/Watchbug_TFG/gsd-core/workflows/transition.md`.
...
- Follow @E:/Proyectos Github/Watchbug_TFG/gsd-core/workflows/diagnose-issues.md
