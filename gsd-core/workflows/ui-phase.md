...
```markdown
Read E:/Proyectos Github/Watchbug_TFG/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/Proyectos Github/Watchbug_TFG/agents/gsd-ui-checker.md for instructions.
...
@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / E:/Proyectos Github/Watchbug_TFG.
...
UI_PROBE_JS=$(for _c in \
  ...
  "E:/Proyectos Github/Watchbug_TFG/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "E:/Proyectos Github/Watchbug_TFG/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
