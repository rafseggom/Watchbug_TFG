...
Key references:
- @E:/Proyectos Github/Watchbug_TFG/gsd-core/references/ui-brand.md (display patterns)
- @E:/Proyectos Github/Watchbug_TFG/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/Proyectos Github/Watchbug_TFG/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/Proyectos Github/Watchbug_TFG/gsd-core/USER-PROFILE.md"
...
```bash
cp "E:/Proyectos Github/Watchbug_TFG/gsd-core/USER-PROFILE.md" "E:/Proyectos Github/Watchbug_TFG/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/Proyectos Github/Watchbug_TFG/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/Proyectos Github/Watchbug_TFG/gsd-core/references/user-profiling.md`
...
Reference: @E:/Proyectos Github/Watchbug_TFG/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to E:/Proyectos Github/Watchbug_TFG/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .clinerules" -- "Add profile to E:/Proyectos Github/Watchbug_TFG/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/Proyectos Github/Watchbug_TFG/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/Proyectos Github/Watchbug_TFG/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to E:/Proyectos Github/Watchbug_TFG/.clinerules"
...
```bash
BACKUP_PATH="E:/Proyectos Github/Watchbug_TFG/USER-PROFILE.backup.md"
```
...
Your profile:    E:/Proyectos Github/Watchbug_TFG/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/Proyectos Github/Watchbug_TFG/skills/gsd-dev-preferences/SKILL.md
  ✓ .clinerules section       <resolved claude_md_path, default ./.cline/.clinerules>
  ✓ Global .clinerules        E:/Proyectos Github/Watchbug_TFG/.clinerules
```
