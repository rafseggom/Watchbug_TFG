...
```
Agent(
  prompt="Read E:/Proyectos Github/Watchbug_TFG/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/VALIDATION.md`
