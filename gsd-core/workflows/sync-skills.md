...
INSTALL_JS_GLOBAL="E:/Proyectos Github/Watchbug_TFG/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/Proyectos Github/Watchbug_TFG/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
