...
<required_reading>
@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/ai-frameworks.md
@E:/Proyectos Github/Watchbug_TFG/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/Proyectos Github/Watchbug_TFG/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/Proyectos Github/Watchbug_TFG/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/Proyectos Github/Watchbug_TFG/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/Proyectos Github/Watchbug_TFG/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/Proyectos Github/Watchbug_TFG/agents/gsd-eval-planner.md for instructions.
