...
- [x] 01-05-PLAN.md — Build pipeline, bundle size check, E2E tests, final verification
...
- [x] 02-03-PLAN.md — Ingest hardening: XSS sanitize, 100KB guard, split CORS, rate limiting per IP+key
...
- [x] 03-01-PLAN.md — Tracer scaffold + Vite build + FastAPI mount + hash router + auth guard + login
